...
export default {
    data() {
        ...
        mounted: function() {
            ...
            if(this.myData.inputBwUIList[0].hyScheme.resCodeList.length==0){
            this.myData.inputBwUIList[0].hyScheme.resCodeList.push(this.sjdz[0].resCode.toString())
            }
            if(this.myData.inputEcoUIList[0].hyScheme.resCodeList.length==0){
            this.myData.inputEcoUIList[0].hyScheme.resCodeList.push(this.sjdz[0].resCode.toString())
            }
            if(this.myData.inputFdUIList[0].hyScheme.resCodeList.length==0){
            this.myData.inputFdUIList[0].hyScheme.resCodeList.push(this.sjdz[0].resCode.toString())
            }
            if(this.myData.inputRoUIList[0].hyScheme.resCodeList.length==0){
            this.myData.inputRoUIList[0].hyScheme.resCodeList.push(this.sjdz[0].resCode.toString())
            }
        },
        watch: {
            $route(to, from) {
