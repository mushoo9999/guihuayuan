    ...
    <div>
        <Row :gutter="60">
            ...
            <Row :gutter="60">
                ...
                <Col span="6"> 保证出力：
                <span>{{checkRes.firmN.toFixed(2)}}</span>(万kW)
                </Col>
                <Col span="6"> 装机容量：
                <span>{{checkRes.insCapacity.toFixed(2)}}</span>(万kW)
                </Col>
            </Row>
            <br>
            <Row :gutter="60">
                ...
                <table class="Mytable3" cellpadding="0" cellspacing="0" border="0">
                    <thead>
                        <tr>
                            <th>序号</th>
                            <th>时间</th>
                            <th>入库流量(m<sup>3</sup>/s)</th>
                            <th>发电流量(m<sup>3</sup>/s)</th>
                            <th>弃水流量(m<sup>3</sup>/s)</th>
                            <th>库水位(m)</th>
                            <th>平均水头(m)</th>
                            <th>出力(万kW)</th>
                        </tr>
